...
import com.nlscan.uhf.demox.manager.MyUhfManager;
...
import com.nlscan.uhf.demox.util.view.SpinerPopWindow;
...
public class MainActivityOld extends Activity {
    ...
    protected void onDestroy() {
        ...
        UHFManager.getInstance(mContext).powerOff();
    }
    ...
    public void initParams(Bundle params) {
        ...
        myUhfManager = MyUhfManager.getInstance(mContext);
    }
