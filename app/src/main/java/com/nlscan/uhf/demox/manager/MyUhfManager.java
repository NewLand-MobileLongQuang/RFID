package com.nlscan.uhf.demox.manager;
...
import com.nlscan.uhf.demox.UhfSetParams;
...
public class MyUhfManager {
    ...
    public static MyUhfManager getInstance(Context context) {
        uhfManager = UHFManager.getInstance(context);
        return manager;
    }
